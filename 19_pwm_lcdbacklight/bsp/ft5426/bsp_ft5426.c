...
void ft5426_init()
{
    ...
    ctint_config.interruptMode = kGPIO_IntRisingOrFallingEdge; // 跳变沿触发
    ...
    /*3、FT5426初始化*/
    ft5426_read_len(FT5426_ADDR, FT5426_IDGLIB_VERSION, 2, regval);
    printf("Touch Firmware Version:%#X\r\n",
           ((unsigned short)regval[0] << 8) | regval[1]);

    ft5426_write_byte(FT5426_ADDR, FT5426_DEVICE_MODE, 0); /* 设置FT5426工作在normal模式 */
    ft5426_write_byte(FT5426_ADDR, FT5426_IDG_MODE, 1);    /* 中断模式 */
    ft5426_dev.initflag = FT5426_INIT_FINISHED;            // 初始化完成标志
}
